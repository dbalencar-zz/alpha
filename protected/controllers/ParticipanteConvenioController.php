...
class ParticipanteConvenioController extends Controller
{
	/**
	...
	{
		$model=new ParticipanteConvenio;
		...
		if(isset($_POST['ParticipanteConvenio']))
		{
			$model->attributes=$_POST['ParticipanteConvenio'];
			if($model->save())
	...
	{
		$model=new ParticipanteConvenio('search');
		$model->unsetAttributes();  // clear any default values
		$model->convenio=Convenio::model()->findByPk($convenio);
		if(isset($_GET['ParticipanteConvenio']))
			$model->attributes=$_GET['ParticipanteConvenio'];
	 ...
	 * @return ParticipanteConvenio the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ParticipanteConvenio::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ParticipanteConvenio $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='participante-convenio-form')
		{
