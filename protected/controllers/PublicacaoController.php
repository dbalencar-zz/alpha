...
class PublicacaoController extends Controller
{
	...
	{
		$publicacao=$this->loadModel($id);
		$licitacao=$publicacao->licitacao_id;
		$publicacao->delete();
	...
	public function actionDownload()
	{
		...
		header('Content-Disposition: attachment; filename='.basename('publicacao.rem'));
		header('Expires: 0');
		header('Cache-Control: must-revalidate');
		header('Pragma: public');
		header('Content-Length: ' . filesize('publicacao.rem'));
		readfile('publicacao.rem');
	}
	 ...
	 * @param Publicacao $model the model to be validated
	 */
