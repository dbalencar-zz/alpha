...
/**
 * This is the model class for table "tipo_certidao".
 *
 * The followings are the available columns in table 'tipo_certidao':
 * @property string $codigo
 * @property string $descricao
 */
class TipoCertidao extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TipoCertidao the static model class
	 */
